<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TW002.aspx.cs" Inherits="WebMES.Admin.TW002" %>
...
<head runat="server">
    ...
    <title>查詢功能-繼承System.Web.UI.Page</title>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td class="auto-style7">
                                                        <dx:ASPxComboBox ID="edFactNo" runat="server" ClientInstanceName="edFactNo" DataSourceID="sdsFact" TextField="FACTNM" ValueField="FACTNO" Width="100%" AllowNull="True" SelectedIndex="0">
                                                        </dx:ASPxComboBox>
                                                    </td>
                                                </tr>
                                                <tr>
