...
{
    public partial class AW002 : System.Web.UI.Page//新建立檔案時繼承自System.Web.UI.Page
    {
        ...
        protected void MainDBGrid_CustomColumnDisplayText(object sender, DevExpress.Web.ASPxGridAfterPerformCallbackEventArgs e)
        {
      ...
      //  //查詢視窗使用
      //  protected void cbkSearchPanel_CallBack(object sender, CallbackClientSideEventsBase e)
      //  {
      //      /*
      ////設定查詢視窗內欄位預設值
